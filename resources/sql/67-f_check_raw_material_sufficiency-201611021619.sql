...
create table pms_order_raw_material_sufficiency_report(
id						bigint,
id_order					bigint not null,
emission_date				timestamp not null default now(),
is_valid					varchar(1) not null default 'S',
...
ALTER TABLE pms_order_raw_material_sufficiency_report 
ADD constraint chk_is_valid CHECK (is_valid in ('S', 'N'));

ALTER TABLE pms_order_raw_material_sufficiency_report 
ADD CONSTRAINT pms_order_raw_material_sufficiency_report_id_pk PRIMARY KEY (id);

ALTER TABLE pms_order_raw_material_sufficiency_report 
ADD constraint pms_order_raw_material_sufficiency_report_fk_01
FOREIGN KEY (id_order) REFERENCES pms_order (id);

create sequence pms_order_raw_material_sufficiency_report_id_sq
increment by 1
minvalue 1
no maxvalue
start with 1
no cycle
owned by pms_order_raw_material_sufficiency_report.id;

create table pms_order_item_raw_material_sufficiency_report(
id											bigint,
id_order_raw_material_sufficiency_report			bigint not null,
id_order_item									bigint not null,
entered_into_producction_quantity					bigint not null,
...
ALTER TABLE pms_order_item_raw_material_sufficiency_report ADD constraint 
chk_entered_into_producction_quantity CHECK  (entered_into_producction_quantity >= 0);

ALTER TABLE pms_order_item_raw_material_sufficiency_report ADD constraint 
chk_pending_to_instanciate_quantity CHECK  (pending_to_instanciate_quantity >= 0);

ALTER TABLE pms_order_item_raw_material_sufficiency_report 
ADD CONSTRAINT pms_order_item_raw_material_sufficiency_report_id_pk PRIMARY KEY (id);

ALTER TABLE pms_order_item_raw_material_sufficiency_report 
ADD constraint pms_order_item_raw_material_sufficiency_report_fk_01
FOREIGN KEY (id_order_raw_material_sufficiency_report) 
REFERENCES pms_order_raw_material_sufficiency_report (id);

ALTER TABLE pms_order_item_raw_material_sufficiency_report 
ADD constraint pms_order_item_raw_material_sufficiency_report_fk_02
FOREIGN KEY (id_order_item) REFERENCES pms_order_item (id);

create sequence pms_order_item_raw_material_sufficiency_report_id_sq
increment by 1
minvalue 1
no maxvalue
start with 1
no cycle
owned by pms_order_item_raw_material_sufficiency_report.id;


create table pms_order_item_raw_material_sufficiency_report_detail(
id											bigint,
id_order_item_raw_material_sufficiency_report		bigint not null,
id_raw_material								bigint not null,
id_measurment_unit								bigint not null,
required_quantity								numeric(11,2) NOT NULL,
available_quantity								numeric(11,2) NOT NULL
);

ALTER TABLE pms_order_item_raw_material_sufficiency_report_detail ADD constraint 
pms_order_item_raw_material_sufficiency_report_detail_uk unique (id_order_item_raw_material_sufficiency_report,id_raw_material,id_measurment_unit);

ALTER TABLE pms_order_item_raw_material_sufficiency_report_detail ADD constraint 
chk_required_quantity CHECK  (required_quantity > 0);

ALTER TABLE pms_order_item_raw_material_sufficiency_report_detail ADD constraint 
chk_required_quantity_02 CHECK  (required_quantity > available_quantity);

ALTER TABLE pms_order_item_raw_material_sufficiency_report_detail ADD constraint 
chk_available_quantity CHECK  (available_quantity >= 0);


ALTER TABLE pms_order_item_raw_material_sufficiency_report_detail 
ADD CONSTRAINT pms_order_item_raw_material_sufficiency_report_detail_id_pk PRIMARY KEY (id);

ALTER TABLE pms_order_item_raw_material_sufficiency_report_detail 
ADD constraint pms_order_item_raw_material_sufficiency_report_detail_fk_01
FOREIGN KEY (id_order_item_raw_material_sufficiency_report) 
REFERENCES pms_order_item_raw_material_sufficiency_report (id);

ALTER TABLE pms_order_item_raw_material_sufficiency_report_detail 
ADD constraint pms_order_item_raw_material_sufficiency_report_detail_fk_02
FOREIGN KEY (id_raw_material) REFERENCES pms_raw_material (id);

ALTER TABLE pms_order_item_raw_material_sufficiency_report_detail 
ADD constraint pms_order_item_raw_material_sufficiency_report_detail_fk_03
FOREIGN KEY (id_measurment_unit) REFERENCES pms_measurment_unit (id);

create sequence pms_order_item_raw_material_sufficiency_report_detail_id_sq
increment by 1
minvalue 1
no maxvalue
start with 1
no cycle
owned by pms_order_item_raw_material_sufficiency_report_detail.id;
