...
increase_over_cost_for_sale_price	bigint not null,
creation_user	 		   varchar(50) ,
creation_date			   timestamp NOT NULL default now(),
last_modif_user 		   varchar(50),
last_modif_date		   timestamp);

--ALTER TABLE pms_product add increase_over_cost_for_sale_price	bigint; not null;
--ALTER TABLE pms_product ALTER COLUMN increase_over_cost_for_sale_price set not null;
--update pms_product set increase_over_cost_for_sale_price = 5;
ALTER TABLE pms_product 
ADD CONSTRAINT 
chk_increase_over_cost_for_sale_price 
check(increase_over_cost_for_sale_price >= 0);--if want to sell at cost price
/*
no top limit
...
ADD CONSTRAINT 
chk_increase_over_cost_for_sale_price 
check(increase_over_cost_for_sale_price <= 100);*/
...
pincrease_over_cost_for_sale_price		bigint,
...
begin
	...
	insert into pms_product
			(id,product_id,product_description,increase_over_cost_for_sale_price,creation_user,creation_date)
	values
			(pid,
			upper(trim(pproduct_id)),
			upper(trim(pproduct_description)),
			pincrease_over_cost_for_sale_price,
			pcreation_user,
			now());
