/*54-UC-INST-ACT-PP-201611031615*/
			...
			if vinstanciable_product_quantity > 0 then
				for vitem_product_counter in 1..vinstanciable_product_quantity loop
					...
					declare
						...
						where order_identifier_number = vorder_record.order_identifier_number;
					begin
				...
				into v_custom_order_raw_material_sufficiency_report_record
					from v_order_raw_material_sufficiency_report
				where 
					id_order = 10 and id_order_item = 12
					group by id_order,id_order_item,entered_into_producction_quantity,pending_to_instanciate_quantity;							
				
				v_order_item_actual_in_progress_quantity := vorder_item_record.actual_in_progress_quantity;				
				...
				actual_in_progress_quantity = v_order_item_actual_in_progress_quantity + v_custom_order_raw_material_sufficiency_report_record.entered_into_producction_quantity,
