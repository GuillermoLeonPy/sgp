...
public class PurchaseInvoiceItemDTOTableTotalsLayout extends HorizontalLayout {


	private final Logger logger = LoggerFactory.getLogger(PurchaseInvoiceItemDTOTableTotalsLayout.class);
	...
	public PurchaseInvoiceItemDTOTableTotalsLayout(final String VIEW_NAME,final List<PurchaseInvoiceItemDTO> listPurchaseInvoiceItemDTO) {
		// TODO Auto-generated constructor stub
		this.VIEW_NAME = VIEW_NAME;
		this.listPurchaseInvoiceItemDTO = listPurchaseInvoiceItemDTO;
		try{
			logger.info("\n PurchaseInvoiceItemDTOTableTotalsLayout()...");
	...
	/*public PurchaseInvoiceItemDTOTableTotalsLayout(Component... children) {
		super(children);
		// TODO Auto-generated constructor stub
	}*/
	...
	private void setUpValueAddedTaxTotals(){		
		...
		if(this.listPurchaseInvoiceItemDTO != null)
			for(PurchaseInvoiceItemDTO vPurchaseInvoiceItemDTO: this.listPurchaseInvoiceItemDTO){
				if(vPurchaseInvoiceItemDTO.getValue_added_tax_10_amount()!=null)
					this.totalValueAdded_10_Tax = totalValueAdded_10_Tax.add(vPurchaseInvoiceItemDTO.getValue_added_tax_10_amount());
				if(vPurchaseInvoiceItemDTO.getValue_added_tax_5_amount()!=null && 
						(vPurchaseInvoiceItemDTO.getId() == null))
					this.totalValueAdded_5_Tax = totalValueAdded_5_Tax.add(vPurchaseInvoiceItemDTO.getValue_added_tax_5_amount());
				if(vPurchaseInvoiceItemDTO.getExempt_amount()!=null && 
						(vPurchaseInvoiceItemDTO.getId() == null))
					this.excemptTotal = this.excemptTotal.add(vPurchaseInvoiceItemDTO.getExempt_amount());
			}	
