...
public class CreditNoteItemDTOTableTotalsLayout extends HorizontalLayout {

	private final Logger logger = LoggerFactory.getLogger(CreditNoteItemDTOTableTotalsLayout.class);
	...
	public CreditNoteItemDTOTableTotalsLayout(			final String VIEW_NAME,
		...
		try{
			logger.info("\n CreditNoteItemDTOTableTotalsLayout()...");
	...
	/*public CreditNoteItemDTOTableTotalsLayout(Component... children) {
		super(children);
		// TODO Auto-generated constructor stub
	}*/
	@Override
	...
	private void setUpValueAddedTaxTotals(){		
		...
		if(this.listCreditNoteItemDTO != null)
			for(CreditNoteItemDTO vCreditNoteItemDTO: this.listCreditNoteItemDTO){
				if(vCreditNoteItemDTO.getValue_added_tax_10_unit_price_amount()!=null)
					this.totalValueAdded_10_Tax = totalValueAdded_10_Tax.add(vCreditNoteItemDTO.getValue_added_tax_10_unit_price_amount());
				if(vCreditNoteItemDTO.getValue_added_tax_5_unit_price_amount()!=null)
					this.totalValueAdded_5_Tax = totalValueAdded_5_Tax.add(vCreditNoteItemDTO.getValue_added_tax_5_unit_price_amount());
				if(vCreditNoteItemDTO.getExempt_unit_price_amount()!=null)
					this.excemptTotal = this.excemptTotal.add(vCreditNoteItemDTO.getExempt_unit_price_amount());
			}
