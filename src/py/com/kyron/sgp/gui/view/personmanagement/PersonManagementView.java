...
public class PersonManagementView extends VerticalLayout implements View {

	private final Logger logger = LoggerFactory.getLogger(PersonManagementView.class);
	private Map<String,String> messages;
	private final String VIEW_NAME = "person.management.";
	...
	public PersonManagementView() {
		...
		try{
	        ...
	        this.searchPersonToolComponent = 
	        		...
	        		DashboardViewType.PERSON_MANAGEMENT.getViewName(), true, false, false, false);
	...
	public PersonManagementView(Component... children) {
		super(children);
		// TODO Auto-generated constructor stub
	}
    ...
    public void detach() {
	 ...
	 public void backNavigationFromRegisterCurrencyFormView(final PersonRegisterFormViewEvent personRegisterFormViewEvent){
		 logger.info("\nPersonManagementView.backNavigationFromRegisterCurrencyFormView"
