...
public class OperationDeliversFinalProductTabLayout extends VerticalLayout {

	private final Logger logger = LoggerFactory.getLogger(OperationDeliversFinalProductTabLayout.class);	
	...
	public OperationDeliversFinalProductTabLayout(
	...
	/*public OperationDeliversFinalProductTabLayout(Component... children) {
		super(children);
		// TODO Auto-generated constructor stub
	}*/
	...
	private void retrieveProductDTO() throws PmsServiceException{
		this.productDTO = this.comercialManagementService.listProductDTO(new ProductDTO(this.productionProcessActivityInstanceDTO.getId_product())).get(0);
	}
	...
	private HorizontalLayout setUpHeader(){
		...
		Label product_descriptionLabel = new Label(this.messages.get("application.common.product.label") + ":");
		product_descriptionLabel.addStyleName(ValoTheme.LABEL_COLORED);
		//product_descriptionLabel.addStyleName(ValoTheme.LABEL_H3);
		Label product_descriptionValue = new Label(this.productDTO.getProduct_description());
		//product_descriptionLabel.addStyleName(ValoTheme.LABEL_H3);
		HorizontalLayout product_descriptionHorizontalLayout = new HorizontalLayout(product_descriptionLabel,product_descriptionValue);
		product_descriptionHorizontalLayout.setSpacing(true);
		column01.addComponent(product_descriptionHorizontalLayout);
		...
		//process_descriptionLabel.addStyleName(ValoTheme.LABEL_H3);
		Label process_descriptionValue = new Label(this.listPAIRawMaterialSupplyDTO.get(0).getProcess_description());
		//process_descriptionValue.addStyleName(ValoTheme.LABEL_H3);
		...
		//activity_descriptionLabel.addStyleName(ValoTheme.LABEL_H4);
		Label activity_descriptionValue = new Label(this.listPAIRawMaterialSupplyDTO.get(0).getActivity_description());
		//activity_descriptionValue.addStyleName(ValoTheme.LABEL_H4);
		...
		Label allocation_date_Label = new Label(this.messages.get(this.VIEW_NAME + "tab.operation.final.product.label.delivery.date") + ":");
	...
	private HorizontalLayout setUpMainTitle(){
        Label title = new Label(this.messages.get(this.VIEW_NAME + "tab.operation.final.product.delivery.main.title"));
		...
		okButton.addClickListener(
				new ClickListener() {
		            ...
		            public void buttonClick(final ClickEvent event) {
		            	try{
		            		productionProcessActivityInstanceOperationsViewFunctions.deliverFinalProduct();
		            	}catch(Exception e){
