...
public class OperationFinalizeActivityTabLayout extends VerticalLayout {

	private final Logger logger = LoggerFactory.getLogger(OperationFinalizeActivityTabLayout.class);	
	...
	public OperationFinalizeActivityTabLayout(			
	...
	/*public OperationFinalizeActivityTabLayout(Component... children) {
		super(children);
		// TODO Auto-generated constructor stub
	}*/
    ...
    public void detach() {
		...
		logger.info("\n==========================================="
				+"\n OperationFinalizeActivityTabLayout" + this.hashCode()
				+"\n detaching ..."
				+"\n===========================================");
	...
	private HorizontalLayout setUpHeader(){
		...
		Label activity_start_work_date_Label = new Label(this.messages.get(this.VIEW_NAME + "tab.operation.finalize.activity.label.activity.start.work.date") + ":");
		activity_start_work_date_Label.addStyleName(ValoTheme.LABEL_COLORED);
		Label activity_start_work_date_Value = new Label(SgpUtils.dateFormater.format(this.productionProcessActivityInstanceDTO.getActivity_start_work_date()));
		HorizontalLayout activity_start_work_date_HorizontalLayout = new HorizontalLayout(activity_start_work_date_Label,activity_start_work_date_Value);
		...
		Label activity_finish_work_date_Value = new Label(SgpUtils.dateFormater.format(new Date()));
		...
		Label activity_duration_Value = new Label(""+SgpUtils.minutesBetweenDates(this.productionProcessActivityInstanceDTO.getActivity_start_work_date(), new Date()));
	...
	private HorizontalLayout setUpMainTitle(){
        Label title = new Label(this.messages.get(this.VIEW_NAME + "tab.operation.finalize.activity.main.title"));
		...
		okButton.addClickListener(
				new ClickListener() {
		            ...
		            public void buttonClick(final ClickEvent event) {
		            	try{
		            		productionProcessActivityInstanceOperationsViewFunctions.finalizeActivity();
		            	}catch(Exception e){
