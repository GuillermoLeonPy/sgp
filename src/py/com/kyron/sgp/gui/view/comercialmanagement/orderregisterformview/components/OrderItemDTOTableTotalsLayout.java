...
public class OrderItemDTOTableTotalsLayout extends HorizontalLayout {

	private final Logger logger = LoggerFactory.getLogger(OrderItemDTOTableTotalsLayout.class);
	...
	public OrderItemDTOTableTotalsLayout(final List<OrderItemDTO> listOrderItemDTO, final BigDecimal credit_order_payment_condition_surcharge_percentage) {
	...
	/*public OrderItemDTOTableTotalsLayout(Component... children) {
		super(children);
		// TODO Auto-generated constructor stub
	}*/
	...
	private void setUpValueAddedTaxTotals(){		
		...
		if(this.listOrderItemDTO != null)
			for(OrderItemDTO vOrderItemDTO: this.listOrderItemDTO){
				if(vOrderItemDTO.getValue_added_tax_10_unit_price_amount()!=null && 
						(vOrderItemDTO.getId() == null	|| (vOrderItemDTO.getStatus()!=null && !vOrderItemDTO.getStatus().equals("application.common.status.discarded") 
						/*&& vOrderItemDTO.getPrevious_status() == null*/)))
					this.totalValueAdded_10_Tax = totalValueAdded_10_Tax.add(vOrderItemDTO.getValue_added_tax_10_unit_price_amount());
				if(vOrderItemDTO.getValue_added_tax_5_unit_price_amount()!=null && 
						(vOrderItemDTO.getId() == null	|| (vOrderItemDTO.getStatus()!=null && !vOrderItemDTO.getStatus().equals("application.common.status.discarded") 
						/*&& vOrderItemDTO.getPrevious_status() == null*/)))
					this.totalValueAdded_5_Tax = totalValueAdded_5_Tax.add(vOrderItemDTO.getValue_added_tax_5_unit_price_amount());
				if(vOrderItemDTO.getExempt_unit_price_amount()!=null && 
						(vOrderItemDTO.getId() == null	|| (vOrderItemDTO.getStatus()!=null && !vOrderItemDTO.getStatus().equals("application.common.status.discarded") 
						/*&& vOrderItemDTO.getPrevious_status() == null*/)))
					this.excemptTotal = this.excemptTotal.add(vOrderItemDTO.getExempt_unit_price_amount());
			}
